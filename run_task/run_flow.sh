...
o2-analysis-lf-nuclei-flow-trees -b --configuration json://configuration.json --shm-segment-size 25000000000 --aod-memory-rate-limit 25000000000 --aod-writer-keep AOD/NUCLEITABLE/0,AOD/NUCLEITABLEFLOW/0 | \
